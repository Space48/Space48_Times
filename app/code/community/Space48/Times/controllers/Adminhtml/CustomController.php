<?php
/**
 * Space 48 Custom Times Controller
 *
 * Space 48 Custom Times Controller, Extends Adminhtml controller action so that all operations
 *          performed inside the custom section of this module can be captured.
 *
 *
 * PHP version 5
 *
 ...
 * @link      http://wiki.space48.com
 */
class Space48_Times_Adminhtml_CustomController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    protected function _loadLayout($loadJs = false, $block = false)
    {
        ...
        if ($block) {
            $this->_addContent(
                $this->getLayout()
                    ->createBlock('space48_times/adminhtml_custom_'  . $block)
            );
        }
    ...
    /**
     * New Action. Used to redirect to the edit function.
     *
     * @return null
     */
